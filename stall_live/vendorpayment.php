				...
				<div class="body_wrap" >
					...
					<div class="row">
				                <div class="col-md-12">
				                	...
				                	<a href="myCompleteEvent.php?user_id=<?php echo $user_id; ?>" class="btn btn-danger" style="color:white;">Back</a>
				                
				                	</div>
				                </div>
								</div>

							<h2 class="section-heading" style="text-align: -webkit-center;"><span class="red">Vendor</span> Payment Info</h2>
							</br>
							<div class="row">
				                <div class="col-md-12">
		                            <div class="card">
