...
<html lang="en">
					...
					<div class="col-12">
						<div class="box">
							<div class="box-header">
								...
								?>
								All Refund Payment Of Vendor <span style="color:red;"><?php echo $first_name; ?>.</span>
								</h3>
	...
	//$book_id = $getData1['book_id'];*/
									...
									$total_amount = $getData['refund_amount'];
									...
									?>
										...
										<td><?php echo $getData['refund_amount']; ?></td>
										</tr>
										</script>
									<?php $a++; } ?>
									<tr style="background-color: #d6e8f1;"><td></td><td></td><td><b>Total Received Amount</b></td><td style="color:green;"><b><?php echo $sum; ?></b></td></tr>	
									<!--<tr style="background-color: #c8dbe4;"><td></td><td><b>Remain Amount</b></td><td style="color:red;"><b><?php echo $remain_amount; ?></b></td><td></td><td></td></tr>	-->
										</tfoot>
								</table>
							</div>
							<!-- /.box-body -->
