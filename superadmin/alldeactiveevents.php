						...
						<div class="col-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Not Approved Events</h3>
									...
									<table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
										...
										?>
											<tr>
												...
												<td><?php echo $geteve['first_name']; ?> <?php echo $geteve['last_name']; ?></td>
												...
												<td>
													<a data-toggle="modal" style="color:white" onclick="edit('<?php echo $geteve["event_id"]; ?>')" data-target="#modal-default" class="btn btn-danger btn-flat">Delete&nbsp;&nbsp;<i class="fa fa-trash"></i></a>
													<a href="updateeventstatus.php?eventid=<?php echo $geteve["event_id"]; ?>&email=<?php echo $geteve["email"]; ?>&user_id=<?php echo $geteve["user_id"]; ?>&status=1" class="btn btn-info btn-flat">Active</a>
													   <a href="eventinfo.php?eventid=<?php echo $geteve["event_id"];?>" style="color:white" class="btn btn-warning btn-flat">View Info&nbsp;&nbsp;</a>
												...
												<!--<td>
													...
													<a href="updateeventstatus.php?eventid=<?php echo $geteve["event_id"]; ?>&email=<?php echo $geteve["email"]; ?>&user_id=<?php echo $geteve["user_id"]; ?>&status=0"><span class="label label-success">Active</span></a>
													<?php } else { ?>
													<a href="updateeventstatus.php?eventid=<?php echo $geteve["event_id"]; ?>&email=<?php echo $geteve["email"]; ?>&user_id=<?php echo $geteve["user_id"]; ?>&status=1"><span class="label label-danger">DeActive</span></a>
													<?php } ?>
												</td>-->
											</tr>
										<?php $i++; } ?>
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						<form name="cat1" id="cat1" method="POST" action="deleteevent.php" enctype="multipart/form-data">
							<input type="hidden" name="neventid" id="neventid" value="">
