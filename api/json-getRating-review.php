...
if(isset($_REQUEST["event_id"]))
{
    ...
    $cn=new connection();
    $res=$cn->getrows("SELECT * FROM user_master um, event_master em, review_ratting_master rm WHERE um.user_id = rm.user_id AND em.event_id = rm.event_id AND rm.event_id='$event_id' ");
