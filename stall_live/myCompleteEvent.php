      ...
      <div class="body_wrap" >
        <div class="page_wrap" >
         ...
         <section>
            ...
            style="background: url(../images/slider/9.jpg);background-size: cover;height: 447px;"
              img src="images/slider/15154038561515238902banner1.jpg"  
            </div>-->
          </section>
          <hr>
          
          <div class="container" style="padding-bottom: 39px;margin-top: 5%;">

            
            <div class="row">
                        
	<h3 style="color:#ea4e47;font-weight:bold;text-align:center;">Complete Event</h3>
                      <div class="col-md-12">
                              <div class="card">
  ...
  <?php
      ...
      $selectEventew = $cnn ->getrows("SELECT * FROM booking_master WHERE user_id = '$user_id'");
      while($getEventew = mysqli_fetch_array($selectEventew))
      {
          $event_id = $getEventew['event_id'];
          $user_id = $getEventew['user_id'];
          
          $selectEvent = $cnn ->getrows("SELECT *FROM event_master WHERE event_id='$event_id' AND end_date < '$today' ");
          ...
          <div class="">
            <div class="card">
                          <div class="evSn2">
                              <div class="row">
                                  <div class="col-md-3">
                                      <img src="../stall_live/<?php echo $getEvent['banner']; ?>" style="width:70%;height:105px;padding-left: 2%;" class="img-responsive img-thumbnail">
                                  </div>
                                  <div class="col-md-9">
                                      <div class="col-md-6">
