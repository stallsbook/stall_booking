...
<html lang="en">
	<head>
		...
		<title>Stall Booking - View Venders</title>
		<!-- Bootstrap 4.0-->
	...
	//$book_id = $getData1['book_id'];
									...
									?>
										...
										<td>
                                            					<a href="oviewAllPayment.php?event_id=<?php echo $event_id; ?>" class="btn btn-success" data-toggle="model" data-target="myModel">View All Payment</a>	
                                            					<a class="btn btn-success" data-toggle="model" data-target="myModel">View All Refund</a>
                                            								</td>
