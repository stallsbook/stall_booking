	...
	<body class="home page-template-default page page-id-133 unicaevents_body body_style_wide body_filled theme_skin_default article_style_stretch layout_single-standard template_single-standard top_panel_show top_panel_above sidebar_hide sidebar_outer_hide wpb-js-composer js-comp-ver-5.1 vc_responsive">
		<div class="body_wrap">
			<div class="page_wrap">
				...
				<div class="vc_row wpb_row vc_row-fluid " style="background: #e0ddd7d9;">
					<h2 class="sc_title sc_title_underline sc_align_center margin_top_small margin_bottom_tiny" style="text-align:center;">Portfolio</h2>
					<h6 class="sc_title sc_title_style1 sc_align_center margin_bottom_large" style="text-align:center;"><span class="sc_title_style1_before"></span>Happy clients PortFolio<span class="sc_title_style1_after"></span></h6>
					<div class="row">
						<?php 
							...
							{
						?>
						<div class="hover01" style="margin: -3% 2%;">
							<div class="col-sm-3">
								<figure><img src="../images/gallery/<?php echo $getImage['images']; ?>" 
							onclick="openModal();currentSlide(<?php echo $i; ?>)" style="width:100%;height: 250px;border-radius: 1%;"></figure>
							</div>
						</div>
...
<?php 
  ...
  <div class="mySlides">
	...
	<img src="../images/gallery/<?php echo $getImage['images']; ?>" style="width:100%">
  </div>
  <?php $i++; } ?>
